...
## [1. Базовые операции над структурами данных](src/mpm/basic_operations_on_data_structures)
...
## [2. Численное интегрирование](src/mpm/numerical_integration)
...
## [3. Параллельная обработка последовательностей](src/mpm/parallel_sequence_processing)
...
## [4. Дизъюнктивная нормальная форма](src/mpm/disjunctive_normal_form)
